...
public class AccountDB{
    ...
    class ADB extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db){
            db.execSQL("CREATE TABLE twitter(_id INTEGER PRIMARY KEY AUTOINCREMENT, nick TEXT, token TEXT, token_secret TEXT, use INTEGER, service TEXT);");
            db.execSQL("CREATE TABLE facebook(_id INTEGER PRIMARY KEY AUTOINCREMENT, nick TEXT, token TEXT, token_secret TEXT, use INTEGER, service TEXT);");
        }
        @Override
    ...
    public void insert_twitter(String nick, String token, String token_secret){
    	sdb.execSQL("INSERT INTO twitter VALUES (null,'"+nick+"','"+token+"','"+token_secret+"','1','twitter');");
    }
    ...
    public void insert_facebook(String nick, String token, String token_secret){
    	sdb.execSQL("INSERT INTO facebook VALUES (null,'"+nick+"','"+token+"','"+token_secret+"','1','facebook');");
    }
